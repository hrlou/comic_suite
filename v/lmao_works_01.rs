...
use eframe::egui::{ColorImage, TextureFilter, TextureOptions, Vec2, Image};
    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            if let Some(img) = &*self.image_cache.lock().unwrap() {
                ...
                let target_size = Vec2::new(w as f32 * scale, h as f32 * scale);
                ...
                ui.add(Image::new((tex.id(), target_size)));
            }
        });
